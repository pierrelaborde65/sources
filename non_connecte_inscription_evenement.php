            ...
            <div class="box">
                <div class="col-lg-12">
					...
					<div class="into-text text-center policy2">
						Veuillez vous connecter pour pouvoir vous inscrire à un événement.
                    </div>
					</br>
					</br>
                    
					<img class="img-responsive img-center-medium img-border" src="img/campagne.jpg" alt="image campagne">
