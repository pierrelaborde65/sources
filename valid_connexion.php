<?php
	if(!isset($_COOKIE['identifiant']))
		header("Refresh: 0; URL=http://php-meilleuretudiant.rhcloud.com/connexion.php" );
	else
{	
?>
<!DOCTYPE html>
            ...
            <div class="box">
                <div class="col-lg-12">
					...
					<div class="into-text text-center policy2">
						Bonjour <?php echo $_COOKIE['identifiant'];?> et bienvenue sur mon site !</br></br>
						Vous pouvez maintenant vous inscrire à un événement ou bien consulter le classement actuel des étudiants !
                    </div>
