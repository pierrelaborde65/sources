				...
				<div class="row">
					<div class="box">
						<div class="col-lg-12">
							...
							<?php
							// on essaie de supprimer l'étudiant de l'événement sélectionné
							try 
							{
								$bdd->beginTransaction();
								$sql = $bdd->prepare("DELETE FROM inscription WHERE num_etudiant =:num_etudiant AND num_evenement=:num_evenement");
							...
							?>	
								...
								Votre désinscription concernant l'événement "<?php echo $nom_eve;?>" a été effectuée !</br>
								</br>
								Vous n'auriez jamais dû faire ça ! Vous allez louper un événement de folie !!!
								</div>
								</br>
								</br>
							...
							// On affiche l'erreur càd le message du trigger si on ne peut pas supprimer l'étudiant de l'événement
							catch(Exception $e)
							{
							?>
								<div class="into-text text-center policy2">
