<?php
	if(!isset($_COOKIE['identifiant']))
		header("Refresh: 0; URL=http://php-meilleuretudiant.rhcloud.com/index.php" );
	else
{	
	// On remet les cookies à null
	setcookie('identifiant',null);
	setcookie('num_etudiant',null);
	setcookie('mot_de_passe',null);
?>
<!DOCTYPE html>
<html> 	
	<head>
