            ...
            <div class="box">
                <div class="col-lg-12">
					...
					<div class="into-text text-center policy2">
						Veuillez vous connecter pour pouvoir vous désinscrire d'un événement.
                    </div>
					</br>
					</br>
                    
					<img class="img-responsive img-center-medium img-border" src="img/barbecue.jpg" alt="image barbecue">
